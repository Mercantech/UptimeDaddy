...
namespace UptimeDaddy.API.Migrations
{
    ...
    [Migration("20260418191303_AddIncidentEventDowntimeDurationMs")]
    partial class AddIncidentEventDowntimeDurationMs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UptimeDaddy.API.Models.MonitorIncidentEvent", b =>
                {
                    ...
                    b.HasIndex("WebsiteId", "OccurredAt")
                        .IsDescending(false, true)
            ...
            modelBuilder.Entity("UptimeDaddy.API.Models.DiscordMonitorSubscription", b =>
                {
                    b.HasOne("UptimeDaddy.API.Models.Website", "Website")
                        ...
                        .HasForeignKey("UptimeDaddy.API.Models.DiscordMonitorSubscription", "WebsiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UptimeDaddy.API.Models.MonitorIncidentState", b =>
                {
                    b.HasOne("UptimeDaddy.API.Models.Website", "Website")
                        ...
                        .HasForeignKey("UptimeDaddy.API.Models.MonitorIncidentState", "WebsiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
